...
namespace Sq1.Adapters.Quik.Terminal {
	public static class Trans2Quik {
		...
		[DllImport("TRANS2QUIK.DLL", EntryPoint = "_TRANS2QUIK_ORDER_QTY@4", CallingConvention = CallingConvention.StdCall)]
		public static extern int ORDER_QTY( int nOrderDescriptor);

		// long TRANS2QUIK_API __stdcall TRANS2QUIK_ORDER_DATE (long nOrderDescriptor);
		[DllImport("TRANS2QUIK.DLL", EntryPoint = "_TRANS2QUIK_ORDER_DATE@4", CallingConvention = CallingConvention.StdCall)]
		public static extern int ORDER_DATE(int nOrderDescriptor);

		// long TRANS2QUIK_API __stdcall TRANS2QUIK_ORDER_TIME (long nOrderDescriptor);
		[DllImport("TRANS2QUIK.DLL", EntryPoint = "_TRANS2QUIK_ORDER_TIME@4", CallingConvention = CallingConvention.StdCall)]
		public static extern int ORDER_TIME(int nOrderDescriptor);

		// long TRANS2QUIK_API __stdcall TRANS2QUIK_ORDER_ACTIVATION_TIME (long nOrderDescriptor);
		[DllImport("TRANS2QUIK.DLL", EntryPoint = "_TRANS2QUIK_ORDER_ACTIVATION_TIME@4", CallingConvention = CallingConvention.StdCall)]
		public static extern int ORDER_ACTIVATION_TIME(int nOrderDescriptor);

		// long TRANS2QUIK_API __stdcall TRANS2QUIK_ORDER_WITHDRAW_TIME (long nOrderDescriptor);
		[DllImport("TRANS2QUIK.DLL", EntryPoint = "_TRANS2QUIK_ORDER_WITHDRAW_TIME@4", CallingConvention = CallingConvention.StdCall)]
		public static extern int ORDER_WITHDRAW_TIME(int nOrderDescriptor);

		// long TRANS2QUIK_API __stdcall TRANS2QUIK_ORDER_EXPIRY (long nOrderDescriptor);
		[DllImport("TRANS2QUIK.DLL", EntryPoint = "_TRANS2QUIK_ORDER_EXPIRY@4", CallingConvention = CallingConvention.StdCall)]
		public static extern int ORDER_EXPIRY(int nOrderDescriptor);

		// double TRANS2QUIK_API __stdcall TRANS2QUIK_ORDER_ACCRUED_INT (long nOrderDescriptor);
		[DllImport("TRANS2QUIK.DLL", EntryPoint = "_TRANS2QUIK_ORDER_ACCRUED_INT@4", CallingConvention = CallingConvention.StdCall)]
		public static extern double ORDER_ACCRUED_INT(int nOrderDescriptor);

		// double TRANS2QUIK_API __stdcall TRANS2QUIK_ORDER_YIELD (long nOrderDescriptor);
		[DllImport("TRANS2QUIK.DLL", EntryPoint = "_TRANS2QUIK_ORDER_YIELD@4", CallingConvention = CallingConvention.StdCall)]
		public static extern double ORDER_YIELD(int nOrderDescriptor);

		// long TRANS2QUIK_API __stdcall TRANS2QUIK_ORDER_UID (long nOrderDescriptor);
		[DllImport("TRANS2QUIK.DLL", EntryPoint = "_TRANS2QUIK_ORDER_UID@4", CallingConvention = CallingConvention.StdCall)]
		public static extern int ORDER_UID(int nOrderDescriptor);

		// LPTSTR TRANS2QUIK_API __stdcall TRANS2QUIK_ORDER_USERID (long nOrderDescriptor);
		[DllImport("TRANS2QUIK.DLL", EntryPoint = "_TRANS2QUIK_ORDER_USERID@4", CallingConvention = CallingConvention.StdCall)]
		public static extern IntPtr ORDER_USERID(int nOrderDescriptor);

		// LPTSTR TRANS2QUIK_API __stdcall TRANS2QUIK_ORDER_ACCOUNT (long nOrderDescriptor); 
		[DllImport("TRANS2QUIK.DLL", EntryPoint = "_TRANS2QUIK_ORDER_ACCOUNT@4", CallingConvention = CallingConvention.StdCall)]
		public static extern IntPtr ORDER_ACCOUNT( int nOrderDescriptor);

		// LPTSTR TRANS2QUIK_API __stdcall TRANS2QUIK_ORDER_BROKERREF (long nOrderDescriptor); 
		[DllImport("TRANS2QUIK.DLL", EntryPoint = "_TRANS2QUIK_ORDER_BROKERREF@4", CallingConvention = CallingConvention.StdCall)]
		public static extern IntPtr ORDER_BROKERREF(int nOrderDescriptor);

		// LPTSTR TRANS2QUIK_API __stdcall TRANS2QUIK_ORDER_CLIENT_CODE (long nOrderDescriptor); 
		[DllImport("TRANS2QUIK.DLL", EntryPoint = "_TRANS2QUIK_ORDER_CLIENT_CODE@4", CallingConvention = CallingConvention.StdCall)]
		public static extern IntPtr ORDER_CLIENT_CODE(int nOrderDescriptor);

		// LPTSTR TRANS2QUIK_API __stdcall TRANS2QUIK_ORDER_FIRMID (long nOrderDescriptor); 
		[DllImport("TRANS2QUIK.DLL", EntryPoint = "_TRANS2QUIK_ORDER_FIRMID@4", CallingConvention = CallingConvention.StdCall)]
		public static extern IntPtr ORDER_FIRMID(int nOrderDescriptor);
