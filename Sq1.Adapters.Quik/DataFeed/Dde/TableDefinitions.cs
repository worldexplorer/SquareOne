	...
	public class TableDefinitions {
		public static List<XlColumn> XlColumnsForTable_Quotes { get {
			return  new List<XlColumn>() {
				...
				new XlColumn() { Name = "last",			TypeExpected = XlBlockType.Float,	Mandatory = true },
				...
				new XlColumn() { Name = "time",			TypeExpected = XlBlockType.String,	ToDateTimeParseFormat = "h:mm:sstt", Mandatory = true },
				new XlColumn() { Name = "changetime",	TypeExpected = XlBlockType.String,	ToDateTimeParseFormat = "h:mm:sstt" },
