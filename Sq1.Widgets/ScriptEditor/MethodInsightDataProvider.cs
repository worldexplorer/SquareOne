...
namespace Sq1.Widgets.ScriptEditor {
	class MethodInsightDataProvider : AbstractInsightDataProvider {
		...
		public override void SetupDataProvider(string fileName) {
			// This class provides the method insight information. To find out which information is requested,
			// it simply compares the word before the caret with 3 hardcoded method names.
