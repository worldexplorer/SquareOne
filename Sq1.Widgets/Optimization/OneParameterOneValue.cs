...
namespace Sq1.Widgets.Optimization {
	public class OneParameterOneValue {
		private OneParameterAllValuesAveraged oneParameterAllValuesAveraged;
		...
		SortedDictionary<int, SystemPerformanceRestoreAble> backtestsWithMyValueAndOnlyChosenOtherValues { get {
			...
			foreach (SystemPerformanceRestoreAble eachRegardless in this.backtestsWithMyValue.Values) {
				if (oneParameterAllValuesAveraged.Optimizer.HasUnchosenParametersExceptFor(eachRegardless, this.oneParameterAllValuesAveraged)) continue;
		...
		private KPIs kPIsLocalMinusGlobal_cached;
