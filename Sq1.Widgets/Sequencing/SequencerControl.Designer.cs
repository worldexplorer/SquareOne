...
namespace Sq1.Widgets.Sequencing {
	partial class SequencerControl {
		...
		private void InitializeComponent() {
			...
			// olvBacktests
			// 
			this.olvBacktests.AllColumns.Add(this.olvcSerno);
			this.olvBacktests.AllColumns.Add(this.olvcTotalPositions);
			this.olvBacktests.AllColumns.Add(this.olvcProfitPerPosition);
			...
			this.olvcProfitFactor.Width = 38;
			// 
			// olvcRecoveryFactor
			// 
			...
			this.olvcRecoveryFactor.Width = 38;
			// 
			// olvcMaxDrawdown
			// 
