...
namespace Sq1.QuikAdapter {
	...
	public class QuikStreamingEditor : StreamingEditor {
		...
		private QuikStreamingProvider quikStreamingProvider {
			get { return base.streamingProvider as QuikStreamingProvider; }
		}

		public QuikStreamingEditor(QuikStreamingProvider quikStreamingProvider, IDataSourceEditor dataSourceEditor)
