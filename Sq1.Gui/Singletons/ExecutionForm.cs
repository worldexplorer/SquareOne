...
namespace Sq1.Gui.Singletons {
	public partial class ExecutionForm : DockContentSingleton<ExecutionForm> {
		...
		public void Initialize(OrderProcessor orderProcessor) {
			...
			this.ExecutionTreeControl.InitializeWith_shadowTreeRebuilt(this.orderProcessor.DataSnapshot.OrdersAutoTree, this.orderProcessor);
		...
		public void PopulateWindowsTitle() {
			this.ExecutionTreeControl.PopulateWindowsTitle();
		}
		...
		//        + this.ExecutionTreeControl.FlushingStats
		//        ;
		//}
