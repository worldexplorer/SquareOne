...
namespace Sq1.Core.Backtesting {
	public class BacktestQuotesGeneratorSixteenStroke : BacktestQuotesGenerator {
		...
		protected override void Assign_priceAndBidOrAsk_dependingOnQuotesPerBar_forStroke(
				Bar barSimulated, int stroke_0to15, out double priceFromBar_granularStrokes_willBeAligned_upstack, out BidOrAsk bidOrAsk) {
			...
			if (stroke_0to15 == 0) {							// stroke_0to15=0
				...
				if (barSimulated.IsWhiteCandle) {
					...
					priceFromBar_granularStrokes_willBeAligned_upstack = barSimulated.Open - nFifths;
				...
				if (barSimulated.IsWhiteCandle) {
					...
					priceFromBar_granularStrokes_willBeAligned_upstack = barSimulated.Low + nFifths;
					bidOrAsk = BidOrAsk.Ask;
				} else {
					double nFifths = barSimulated.HighLowDistance * distancePart;
					priceFromBar_granularStrokes_willBeAligned_upstack = barSimulated.High - nFifths;
					bidOrAsk = BidOrAsk.Bid;
				}
