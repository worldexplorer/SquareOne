	...
	public partial class Position {
		...
		public double MFE {	// will be always positive
			get {
				...
				if (barExitOrStreaming == this.mfeUptoBar) return this.mfeUptoValue;
				...
				this.mfeUptoBar = barExitOrStreaming; 
		...
		public double MAE {	// will be always negative
			get {
				...
				int barExitOrStreaming = (this.ExitFilledBarIndex != -1) ? this.ExitFilledBarIndex : this.Bars.Count - 1;
				if (barExitOrStreaming == this.maeUptoBar) return this.maeUptoValue;
				...
				this.maeUptoBar = barExitOrStreaming; 
