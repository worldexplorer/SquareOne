...
namespace Sq1.Core.Livesim {
	public partial class LivesimStreamingEditor {
		...
		public void Initialize(LivesimStreamingSettings livesimStreamingSettings) {
			...
			this.cbx_GenerateWideSpreadWithZeroSize						.Checked = this.livesimStreamingSettings.GenerateWideSpreadWithZeroSize;
			this.txt_levelTwoLevelsToGenerate								.Text = this.livesimStreamingSettings.LevelTwoLevelsToGenerate						.ToString();
		}
	}
}
