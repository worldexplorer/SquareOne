...
namespace Sq1.Charting {
	public partial class PanelPrice {
		...
		public int		PixelsPerPriceStep5pxLeast_cached		{ get {
				int minimumPriceLevelThicknessRendered = this.ChartControl.ChartSettings.LevelTwoMinimumPriceLevelThicknessRendered;
